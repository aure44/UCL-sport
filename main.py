...
parser.add_argument('-head', '--headless', action='store_true')
...
print("date successfully changed to", web_date)
...
while True:
    ...
    try:
        ...
        time.sleep(1)
        if not count%20:
            print("Still waiting for the session to open or a vacant spot")
